      ...
      <div className="toolbar">
        ...
        <div className="toolbar-actions">
          ...
          */}
          ...
          {/* Un borrador incompleto se guarda igual; lo que queda bloqueado es publicarlo. */}
          <button
            className="button primary"
            onClick={onPublish}
            disabled={saving || !editorErrors.canPublish}
            title={editorErrors.canPublish ? undefined : editorErrors.structure ?? 'Completá los contenedores marcados antes de publicar'}
          >
